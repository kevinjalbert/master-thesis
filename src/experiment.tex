...
\begin{itemize}
  ...
  \item We conducted a grid search on the individual subjects and then the \emph{all_but_<subject>} sets.
  ...
  \item We picked the parameter pairing that appeared highest on both the individual subjects and the \emph{all_but_<subject>} sets.
\end{itemize}

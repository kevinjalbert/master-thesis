...
\begin{table}[ht!]
  ...
  \begin{threeparttable}
    \begin{tabular}{|c|>{\raggedleft\arraybackslash}p{3.75cm}|>{\raggedleft\arraybackslash}p{3.75cm}|}
      ...
      \hline \ding{174} & N/A~\tnote{a} & N/A~\tnote{a} \\
    ...
    \end{tabular}
    \begin{tablenotes}
      \item[a] Feature set \ding{174} only effects the class feature space.
    \end{tablenotes}
  \end{threeparttable}

...
\begin{itemize}
  ...
  \item In Section~\ref{subsec:experiment_prediction} we evaluated our prediction approach on unknown data within individual test subjects and across test subjects. Our results showed that class-level mutation score was more difficult to predict, while method-level predictions performed better than class-level predictions. Furthermore predictions of unknown data within an individual test subject yielded higher accuracy than across test subjects.

...
\begin{scope}
	...
	\pgftext[center, base, at={\pgfpoint{176.54pt}{119.774pt}}]{\fontsize{12}{0}\selectfont{\textbf{The Exclusion of Feature }}}
	\pgftext[center, base, at={\pgfpoint{254.345pt}{119.774pt}}]{\fontsize{12}{0}\selectfont{\textit{\textbf{X}}}}
	\pgftext[center, base, at={\pgfpoint{316.211pt}{119.774pt}}]{\fontsize{12}{0}\selectfont{\textbf{ from Previous Set (}}}
	\pgftext[center, base, at={\pgfpoint{411.624pt}{119.774pt}}]{\fontsize{12}{0}\selectfont{\textit{\textbf{from the left}}}}
	\pgftext[center, base, at={\pgfpoint{451.382pt}{119.774pt}}]{\fontsize{12}{0}\selectfont{\textbf{)}}}
	\color[rgb]{0.172549,0.172549,0.172549}
	\pgftext[center, base, at={\pgfpoint{63.0617pt}{166.155pt}},rotate=45]{\fontsize{12}{0}\selectfont{all}}
	\pgftext[center, base, at={\pgfpoint{73.9802pt}{159.512pt}},rotate=45]{\fontsize{12}{0}\selectfont{STNBD}}
	\pgftext[center, base, at={\pgfpoint{92.4966pt}{162.219pt}},rotate=45]{\fontsize{12}{0}\selectfont{STVG}}
	\pgftext[center, base, at={\pgfpoint{109.62pt}{162.781pt}},rotate=45]{\fontsize{12}{0}\selectfont{NSM}}
	\pgftext[center, base, at={\pgfpoint{126.935pt}{163.534pt}},rotate=45]{\fontsize{12}{0}\selectfont{NOT}}
	\pgftext[center, base, at={\pgfpoint{143.53pt}{163.567pt}},rotate=45]{\fontsize{12}{0}\selectfont{NSC}}
	\pgftext[center, base, at={\pgfpoint{153.255pt}{158.73pt}},rotate=45]{\fontsize{12}{0}\selectfont{ATMLOC}}
	\pgftext[center, base, at={\pgfpoint{173.871pt}{160.785pt}},rotate=45]{\fontsize{12}{0}\selectfont{BCOV}}
	\pgftext[center, base, at={\pgfpoint{190.146pt}{161.25pt}},rotate=45]{\fontsize{12}{0}\selectfont{APAR}}
	\pgftext[center, base, at={\pgfpoint{209.199pt}{163.742pt}},rotate=45]{\fontsize{12}{0}\selectfont{AVG}}
	\pgftext[center, base, at={\pgfpoint{223.615pt}{161.596pt}},rotate=45]{\fontsize{12}{0}\selectfont{BTOT}}
	\pgftext[center, base, at={\pgfpoint{241.138pt}{162.556pt}},rotate=45]{\fontsize{12}{0}\selectfont{NOM}}
	\pgftext[center, base, at={\pgfpoint{258.835pt}{163.692pt}},rotate=45]{\fontsize{12}{0}\selectfont{NSF}}
	\pgftext[center, base, at={\pgfpoint{273.899pt}{162.194pt}},rotate=45]{\fontsize{12}{0}\selectfont{ATVG}}
	\pgftext[center, base, at={\pgfpoint{287.001pt}{159.487pt}},rotate=45]{\fontsize{12}{0}\selectfont{ATNBD}}
	\pgftext[center, base, at={\pgfpoint{308.603pt}{164.528pt}},rotate=45]{\fontsize{12}{0}\selectfont{SIX}}
	\pgftext[center, base, at={\pgfpoint{321.913pt}{161.275pt}},rotate=45]{\fontsize{12}{0}\selectfont{SPAR}}
	\pgftext[center, base, at={\pgfpoint{338.712pt}{161.512pt}},rotate=45]{\fontsize{12}{0}\selectfont{LCOM}}
	\pgftext[center, base, at={\pgfpoint{354.255pt}{160.494pt}},rotate=45]{\fontsize{12}{0}\selectfont{NORM}}
	\pgftext[center, base, at={\pgfpoint{370.605pt}{161.034pt}},rotate=45]{\fontsize{12}{0}\selectfont{ANBD}}
	\pgftext[center, base, at={\pgfpoint{387.192pt}{161.059pt}},rotate=45]{\fontsize{12}{0}\selectfont{SNBD}}
	\pgftext[center, base, at={\pgfpoint{401.504pt}{158.809pt}},rotate=45]{\fontsize{12}{0}\selectfont{AMLOC}}
	\pgftext[center, base, at={\pgfpoint{423.023pt}{163.766pt}},rotate=45]{\fontsize{12}{0}\selectfont{SVG}}
	\pgftext[center, base, at={\pgfpoint{436.545pt}{160.726pt}},rotate=45]{\fontsize{12}{0}\selectfont{WMC}}
	\pgftext[center, base, at={\pgfpoint{457.249pt}{164.869pt}},rotate=45]{\fontsize{12}{0}\selectfont{DIT}}
	\pgftext[center, base, at={\pgfpoint{464.944pt}{156.755pt}},rotate=45]{\fontsize{12}{0}\selectfont{STMLOC}}
	\pgftext[center, base, at={\pgfpoint{483.585pt}{158.834pt}},rotate=45]{\fontsize{12}{0}\selectfont{SMLOC}}
	\color[rgb]{0,0,0}

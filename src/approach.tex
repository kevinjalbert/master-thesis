...
\begin{sidewaystable}[!tb]
  \centering
	\caption{Extracted coverage test suite metrics (feature set \ding{173} of Table~\ref{tab:feature_sets}) of the \texttt{Triangle} system.}
	...
	\centering
	\caption{Merged test suite metrics (feature set \ding{175} in Table~\ref{tab:feature_sets}) for each source code unit of the \texttt{Triangle} system.}
	...
	\centering
	\caption{Aggregation of method-level source code metrics for each class-level source code unit (feature set \ding{174} of Table~\ref{tab:feature_sets}) of the \texttt{Triangle} system.}

...
\begin{landscape}
	\begin{table}[h]
 	 ...
 	 \begin{tabular}{|l|r|r|r|}
 	   ...
 	   \hline
 	 \end{tabular}
 	 \caption{Extracted coverage test suite metrics (feature set \ding{173} of Table~\ref{tab:metrics}) of the \texttt{Triangle} system.}
 	 \vspace{2mm}
 	 \hrule
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|r|r|}
      ...
      \hline
    \end{tabular}
    \caption{Merged test suite metrics (feature set \ding{175} in Table~\ref{tab:metrics}) for each source code unit of the \texttt{Triangle} system.}
    \vspace{2mm}
    \hrule
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|r|r|}
      ...
      \hline
    \end{tabular}
    \caption{Aggregation of method-level source code metrics for each class-level source code unit (feature set \ding{174} of Table~\ref{tab:metrics}) of the \texttt{Triangle} system.}
    \vspace{2mm}
    \hrule

...
\begin{table}[h]
  ...
  \vspace{1mm}
  \footnotesize{\emph{Table~\ref{tab:metrics} shows the complete set of metrics used as attributes for each vector of the \gls{svm}, categorized by feature set (\ding{172}: Source Code, \ding{173}: Coverage, \ding{174}: Accumulated Source Code, \ding{175}: Accumulated Test Case).}}
  \vspace{2mm}
  \hrule
  \label{tab:metrics}
\end{table}

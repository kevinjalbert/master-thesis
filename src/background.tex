...
\begin{table}[!b]
  ...
  \vspace{1mm}
  \footnotesize{\emph{Table~\ref{tab:metrics} shows the set of metrics used in our research organized by feature set (\ding{172}: Source Code Metrics, \ding{173}: Coverage Metrics, \ding{174}: Accumulated Source Code Metrics, \ding{175}: Accumulated Test Case Metrics).}}
  \vspace{1mm}
  \label{tab:metrics}
\end{table}
